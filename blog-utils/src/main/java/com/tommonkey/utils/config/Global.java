package com.tommonkey.utils.config;
...
public class Global {
    ...
    static {
        ...
        if (loader == null || loader.getProperties().size() == 0) {
            ...
            if (com.tommonkey.utils.common.StringUtils.isNotEmpty(configPath)) {
                loader = new PropertiesLoader(1, configPath + "/application.properties");
            }
        }
        String value = loader.getProperty("rel-properties");
        if (com.tommonkey.utils.common.StringUtils.isNotEmpty(value)) {
            String[] values = com.tommonkey.utils.common.StringUtils.split(",");
            if (values != null && values.length > 0) {
                for (String str : values) {
                    if (com.tommonkey.utils.common.StringUtils.isNotEmpty(value)) {
                        String[] properties = com.tommonkey.utils.common.StringUtils.split(":");
    ...
    public static String getConfig(String propertiesKey, String paramKey) {
        ...
        if (value == null) {
            ...
            if (loader != null) {
                ...
                map.put(propertiesKey + "-" + paramKey, value != null ? value : com.tommonkey.utils.common.StringUtils.EMPTY);
            }
        }
        return value;
    }
