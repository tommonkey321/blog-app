        ...
        try {
            if(factory.isCluster()){
                ...
                if (jedisCluster.exists(key)) {
                    ...
                    value = com.tommonkey.utils.common.StringUtils.isNotBlank(value) && !"nil".equalsIgnoreCase(value) ? value : null;
                }
            }else{
...
//            log.debug("exists {}", key);
    ...
    private static byte[] getBytesKey(Object object) {
        if (object instanceof String) {
            return com.tommonkey.utils.common.StringUtils.getBytes((String) object);
        } else {
            return com.tommonkey.utils.common.ObjectUtils.serialize(object);
        }
    }
    ...
    public static Object toObject(byte[] bytes) {
        return com.tommonkey.utils.common.ObjectUtils.unserialize(bytes);
    }
