 ...
 */
package com.tommonkey.utils.response;
...
public class Response implements Serializable {
    ...
    public String toString() {
        try {
            return com.tommonkey.utils.common.JsonUtil.object2Json(this);
        } catch (IOException e) {
            logger.error("", e);
        }
        return "";
    ...
    public void setData(Object data) {
        if (data != null && data instanceof String) {
            try {
                data = com.tommonkey.utils.common.JsonUtil.json2Map((String) data);
            } catch (Exception e) {
                try {
                    data = com.tommonkey.utils.common.JsonUtil.json2List((String) data);
                } catch (Exception e1) {
