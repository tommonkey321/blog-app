 ...
 */
package com.tommonkey.utils.http.entity;
...
public class CfgBusiBase implements java.io.Serializable{
    ...
    private Map<String, List<com.tommonkey.utils.http.entity.CfgSrvParamMapping>> paramMap;
    ...
    public Map<String, List<com.tommonkey.utils.http.entity.CfgSrvParamMapping>> getParamMap() {
        return paramMap;
    }

    public void setParamMap(Map<String, List<com.tommonkey.utils.http.entity.CfgSrvParamMapping>> paramMap) {
