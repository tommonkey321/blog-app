 ...
 */
public class SHAztHandler implements com.tommonkey.utils.http.handler.Handler {
     ...
     */
    @Override
    public HttpRequest before(com.tommonkey.utils.http.entity.CfgHttpClient cfgHttpClientEntity, Map<String, Object> busiParam) throws Exception {
        return null;
    }
