...
import com.tommonkey.utils.http.client.response.HttpResponseByte;
import com.tommonkey.utils.http.client.response.HttpResponseString;
...
public class SHCrmHandler implements Handler {
    ...
    public HttpRequest before(CfgHttpClient cfgHttpClientEntity, Map<String, Object> busiParam) throws Exception {
        ...
        com.tommonkey.utils.http.handler.sh.RequestBean requestBean = initRequest(clientCode, busiParam);
    ...
    private com.tommonkey.utils.http.handler.sh.RequestBean initRequest(String clientCode, Map<String, Object> busiMap) {
        com.tommonkey.utils.http.handler.sh.RequestBean request = new com.tommonkey.utils.http.handler.sh.RequestBean();
