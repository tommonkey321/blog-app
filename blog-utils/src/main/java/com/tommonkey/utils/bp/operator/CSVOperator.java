...
public class CSVOperator extends FileOperator {
     ...
     */
    @Override
    public List<List<List<String>>> doAnalyse(com.tommonkey.utils.bp.entity.CfgBpTemplate cfgBpTemplateEntity, com.tommonkey.utils.bp.entity.EsBpData esBpDataEntity, ElecInst elecInst) throws Exception {
