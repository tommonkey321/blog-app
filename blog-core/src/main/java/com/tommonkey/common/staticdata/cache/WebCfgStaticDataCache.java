package com.tommonkey.common.staticdata.cache;
...
public class WebCfgStaticDataCache extends DefaultCache {
    ...
    protected Map getData() throws Exception {
        ...
        List<com.tommonkey.utils.export.CfgStaticDataEntity> webCfgStaticDataEntityList = new ArrayList<>();
        ...
        if (cfgStaticDataEntityList != null && cfgStaticDataEntityList.size() > 0) {
            for (CfgStaticDataEntity cfgStaticDataEntity : cfgStaticDataEntityList) {
                ...
                com.tommonkey.utils.export.CfgStaticDataEntity webEntity = new com.tommonkey.utils.export.CfgStaticDataEntity();
            ...
            for (com.tommonkey.utils.export.CfgStaticDataEntity cfgStaticDataEntity : webCfgStaticDataEntityList) {
