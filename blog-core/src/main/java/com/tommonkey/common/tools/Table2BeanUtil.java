package com.tommonkey.common.tools;
...
public class Table2BeanUtil {
   ...
   * */
    ...
    public static void writeEntity(String tableName, String path, List tab_columns) throws Exception {
        ...
        //引用本地包
        head.append("import com.tommonkey.common.persistence.entity.BaseEntity;\n");
        if (constraintsKey.size() > 0) {
            head.append("import com.tommonkey.common.persistence.annotation.Id;");
        }
        head.append("\n\n");
        //引用java包
        if (hasDate == true) {
    ...
    public static void writeDao(String tableName, String path) throws Exception {
        ...
        // 引用本地包
        head.append("import com.tommonkey.common.persistence.annotation.Dao;\n");
        head.append("import com.tommonkey.common.persistence.dao.CrudDao;\n");
    ...
    public static void writeSV(String tableName, String path) throws Exception {
        ...
        head.append("import com.tommonkey.common.persistence.service.CrudService;\n\n");
        /*----------------------------------------写入-----------------------------------------------*/
        write(head.toString() + "" + body.toString(),
    ...
    public static void writeSVImpl(String tableName, String path) throws Exception {
        ...
        //引用本地包
        head.append("import com.tommonkey.common.persistence.dao.CrudDao;\n");
        head.append("import com.tommonkey.common.persistence.service.CrudServiceImpl;\n");
