...
import com.tommonkey.common.process.dao.ICfgTaskInsDao;
import com.tommonkey.common.process.entity.*;
import com.tommonkey.common.process.service.interfaces.*;
...
import com.tommonkey.utils.sec.entity.Station;
...
public class CfgTaskInsSVImpl implements ICfgTaskInsSV {
	...
	private void completeTask(CfgTaskInsEntity taskInsEntity,Map params) throws Exception{
		...
		if(SessionManager.getUser()!=null){
			...
			taskInsEntity.setDealOpName(userInfoInterface.getNikeName());
		}
