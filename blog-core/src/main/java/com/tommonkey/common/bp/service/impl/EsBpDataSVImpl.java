...
import com.tommonkey.common.bp.dao.*;
...
import com.tommonkey.utils.bp.operator.FileOperator;
import com.tommonkey.utils.bp.FileOperateFactory;
import com.tommonkey.utils.bp.entity.CfgBpTemplate;
import com.tommonkey.utils.bp.entity.EsBpData;
...
import com.tommonkey.common.bp.entity.*;
...
public class EsBpDataSVImpl implements IEsBpDataSV {
        ...
        for (ElecInstEntity elecInstEntity : elecInstEntityList) {
            ...
            for (List<List<String>> shell : fileData) {
                ...
                for (List<String> row : shell) {
                    ...
                    if (i <= headerLines) {
                        esBpDataRowEntity.setRowType(com.tommonkey.utils.bp.Constants.RowType.HEADER);
                        esBpDataRowEntity.setState(Constants.RowState.SUCCESS);
                    } else {
                        esBpDataRowEntity.setRowType(com.tommonkey.utils.bp.Constants.RowType.CONTENT);
    ...
    public void processFile(EsBpDataEntity esBpDataEntity) throws Exception {
        ...
        esBpDataRowEntityQuery.setRowType(com.tommonkey.utils.bp.Constants.RowType.CONTENT);
    ...
    public Map<String, Object> queryErrorData(Long dataId) throws Exception {
        ...
        esBpDataRowHisEntityQuery.setRowType(com.tommonkey.utils.bp.Constants.RowType.CONTENT);
        ...
        esBpDataRowEntityQuery2.setRowType(com.tommonkey.utils.bp.Constants.RowType.HEADER);
