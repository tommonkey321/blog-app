package com.tommonkey.common.split;
...
import com.tommonkey.common.split.cache.SplitTableCache;
import com.tommonkey.common.split.entity.CfgTableSplitEntity;
import com.tommonkey.common.split.entity.CfgTableSplitMappingEntity;
...
import com.tommonkey.common.utils.ExceptionUtil;
                ...
                if (entitys != null && entitys.size() > 0) {
                    ...
                    for (BaseEntity entity : entitys) {
                        ...
                        if (resultObj == null) {
                            ...
                            if (StringUtils.equals(convertClassName, "YYYYConvertSVImpl") ||
                                    StringUtils.equals(convertClassName, "YYYYMMConvertSVImpl") ||
                                    StringUtils.equals(convertClassName, "YYYYMMDDConvertSVImpl")) {
                                break;
