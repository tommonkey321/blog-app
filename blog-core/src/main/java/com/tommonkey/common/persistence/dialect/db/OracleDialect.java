 ...
 */
package com.tommonkey.common.persistence.dialect.db;

import com.tommonkey.common.his.HisEntityFactory;
import com.tommonkey.common.his.entity.CfgHisTableConfigEntity;
import com.tommonkey.common.id.IdGeneratorFactory;
import com.tommonkey.common.persistence.SQLHelper;
import com.tommonkey.common.persistence.annotation.Entity;
import com.tommonkey.common.persistence.annotation.Id;
import com.tommonkey.common.persistence.dialect.Dialect;
...
import com.tommonkey.common.split.SplitTableFactory;
import com.tommonkey.common.support.CommonSqlSessionTemplate;
...
import com.tommonkey.common.utils.ReflectionsUtils;
    ...
    public String insert(Class<?> clazz, Object param) throws Exception {
        ...
        if (sqlCache.containsKey(sqlCacheKey)) {
            ...
            if (fields != null && fields.length > 0) {
                ...
                sql.append(SQLHelper.getTableName(clazz)).append("(" + columnSql.substring(0, columnSql.length() - 1) + ")");
                if (isBatchSave) {
    ...
    private void dealHisEntity(Class<?> clazz, Object param, String hisType) throws Exception {
        ...
        if (hisTableConfigEntity != null && hisTableConfigEntity.getDeleteType() == 2) {
            if (StringUtils.equals("UPB", hisType) && StringUtils.isNotEmpty(hisTableConfigEntity.getUpbHisTableName())) {//修改
                ...
                commonSqlSessionTemplate.insert("com.tommonkey.common.persistence.dao.CommonMethodMapper." + CommConstants.CrudDaoSql.INSERT_UPB_HIS, map);
                ...
                map.put(CommConstants.CrudDaoSql.KEY_DAO_CLASS, clazz);
                map.put(CommConstants.CrudDaoSql.KEY_PARAMS, param);
                commonSqlSessionTemplate.insert("com.tommonkey.common.persistence.dao.CommonMethodMapper." + CommConstants.CrudDaoSql.INSERT_DEL_HIS, map);
            }
        }
    }
